    ...
    <header className="bg-black text-white p-4 flex justify-between items-center relative">
      ...
      <div className="hidden md:block">
        <nav className="md:flex md:flex-row space-x-4 text-xl relative">
          <DropdownButton ref={dropdownRef} id="dropdown-basic-button" title="Alumnos" className="relative z-10">
            <Dropdown.Item as={Link} to="/Alumnos" className="block px-2 py-2 w-32 text-white bg-black">Inscritos</Dropdown.Item>
            <Dropdown.Item as={Link} to="/Pagos" className="block py-2 px-2 text-white bg-black">Pagos</Dropdown.Item>
            <Dropdown.Item as={Link} to="/Eventos" className="block py-2 px-2 text-white bg-black">Eventos</Dropdown.Item>
            <Dropdown.Item as={Link} to="/Pedidos" className="block py-2 px-2 text-white bg-black">Pedidos</Dropdown.Item>
            <Dropdown.Item as={Link} to="/Asistencia" className="block py-2 px-2 text-white bg-black">Asistencia</Dropdown.Item>
          </DropdownButton>
      ...
      {isOpen && (
        <div className="fixed top-20 left-0 w-full bg-black p-4 md:hidden flex flex-col space-y-4 z-50" ref={menuRef}>
          ...
          <Link to="/Instructores" className="text-white text-lg">Instructores</Link>
